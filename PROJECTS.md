...
- Lua & Neovim Plugins
  - **_[Raphael.nvim](https://github.com/mavomen/raphael.nvim)_**: Dynamic theme‑management engine for Neovim ≥ 0.10. Supports filetype‑specific theme application, workspace‑level theme profiles, instant palette switching, and an ergonomic Lua API designed for composable, zero‑surprise UI theming.
